 ...
 */
@TargetFragmentTag(FragmentTag.FRAGMENT_NEXT)
public class NextFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view.findViewById(R.id.mFragmentNextTV).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                LogUtils.e("点击了返回栈");
                FragmentFactory.getInstance().showFragment(FragmentTag.FRAGMENT3);
            }
        });
        return view;
    }
